...
public class LanguageInterpreter extends ServiceRequests {
    ...
    public LanguageInterpreter(int id, String firstName, String lastName, String location, String description, String status, int priority, String language, String completedBy, Timestamp createdOn, Timestamp started, Timestamp completedOn) {
        super("Language Interpreter", id, firstName, lastName, location, description, status, priority, completedBy, createdOn, started, completedOn);
        this.language = language;
    }
